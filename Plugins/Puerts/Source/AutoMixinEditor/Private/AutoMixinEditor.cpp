...
// 获取当前活动蓝图
UBlueprint* FAutoMixinEditorModule::GetActiveBlueprint() const
{
	if (const FBlueprintEditorModule* BlueprintEditorModule = FModuleManager::GetModulePtr<FBlueprintEditorModule>("Kismet"))
	{
		...
		if (const FBlueprintEditor* BlueprintEditor = static_cast<FBlueprintEditor*>(FocusedEditor.Get()))
		{
...
FString FAutoMixinEditorModule::ProcessTemplate(const FString& TemplateContent, FString BlueprintPath, FString FileName)
{
...
FName FAutoMixinEditorModule::GetStyleName() const
{
